...
export const AddSubtitle = (props: Props) => {
  ...
  const handleAdd = useCallback(async () => {
    ...
    if (Number(volume) < 0 || Number(volume) % 1 != 0) {
      alert("Input volume as aninteger");
      return;
    }
    if (isbn === "") {
    ...
    <>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          ...
          onClose={closeModal}
        >
          <div className="min-h-screen px-4 text-center border">
            <span
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-6 overflow-hidden text-left align-middle transition-all transform border border-gray-300 shadow-xl bg-gray-50 rounded-xl">
                <Dialog.Title
                  as="h3"
